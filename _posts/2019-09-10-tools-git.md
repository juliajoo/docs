...
![Flowchart Push Button](/docs/assets/res/git-create.png)
...
![Flowchart Push Button](/docs/assets/res/git-link-clone.png)
...
![Flowchart Push Button](/docs/assets/res/git-clone.png)
...
![Flowchart Push Button](/docs/assets/res/git_change.png)
...
![Flowchart Push Button](/docs/assets/res/git_stage.png)
...
![Flowchart Push Button](/docs/assets/res/git_commit.png)
